...
class DyGFormer5(nn.Module):
    ...
    def __init__(self, node_raw_features: np.ndarray, edge_raw_features: np.ndarray, neighbor_sampler: NeighborSampler,
        ...
        """
        super(DyGFormer5, self).__init__()
    ...
    def compute_src_dst_node_temporal_embeddings(self, src_node_ids: np.ndarray, dst_node_ids: np.ndarray, node_interact_times: np.ndarray, full_data: Data, latest_training_time):
        ...
        src_nodes_neighbor_ids_list = [*src_nodes_neighbor_ids_list, *src_recent_ids_list, *dst_recent_ids_list]
        src_nodes_edge_ids_list = [*src_nodes_edge_ids_list, *recent_edges_list, *recent_edges_list]
        src_nodes_neighbor_times_list = [*src_nodes_neighbor_times_list, *recent_times_list, *recent_times_list]

        dst_nodes_neighbor_ids_list = [*dst_nodes_neighbor_ids_list, *src_recent_ids_list, *dst_recent_ids_list]
        dst_nodes_edge_ids_list = [*dst_nodes_edge_ids_list, *recent_edges_list, *recent_edges_list]
        dst_nodes_neighbor_times_list = [*dst_nodes_neighbor_times_list, *recent_times_list, *recent_times_list]
