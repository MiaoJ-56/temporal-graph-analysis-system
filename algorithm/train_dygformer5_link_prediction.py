...
from models.DyGFormer0 import DyGFormer0
from models.DyGFormer1 import DyGFormer1
from models.DyGFormer2 import DyGFormer2
from models.DyGFormer3 import DyGFormer3
from models.DyGFormer4 import DyGFormer4
from models.DyGFormer5 import DyGFormer5
from models.EesyMLP import EasyMLP
from models.modules import MergeLayer
from utils.DataLoader import get_link_prediction_data, get_idx_data_loader
from utils.EarlyStopping import EarlyStopping
from utils.load_configs import get_link_prediction_args
from utils.metrics import get_link_prediction_metrics
from utils.utils import get_neighbor_sampler, NegativeEdgeSampler, set_random_seed, get_parameter_sizes, \
    create_optimizer, convert_to_gpu
...
if __name__ == '__main__':
    ...
    for run in range(args.num_runs):
        ...
        dynamic_backbone = DyGFormer5(node_raw_features=node_raw_features, edge_raw_features=edge_raw_features, neighbor_sampler=train_neighbor_sampler,
        ...
        for epoch in range(args.num_epochs):
            ...
            for batch_idx, train_data_indices in enumerate(train_idx_data_loader_tqdm):
                ...
                batch_src_node_embeddings, batch_dst_node_embeddings = \
                    model[0].compute_src_dst_node_temporal_embeddings(src_node_ids=batch_src_node_ids,
                                                                      ...
                                                                      full_data=full_data,
                                                                      latest_training_time=train_data.node_interact_times[-1])
            ...
            # compute the validation set losses
            ...
            # select the best model based on all the validation metrics
